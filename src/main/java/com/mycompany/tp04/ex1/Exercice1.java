...
public class Exercice1 {
    public static void main(String[] args) {
        ...
        BankAccount account = new SavingsAccount(201 , 3.5 ,1);
        ...
        SavingsAccount savingsAccount1 = new SavingsAccount(101, 5.0 ,1);
        ...
        CheckingAccount checkingAccount1 = new CheckingAccount(102, 500.0,1);
